...
for (i = 0; i < l; i++) {
  var zone = JSON.stringify(jsonContent[i].mapInfo.mapHierarchyString);
    ...
    if (zone === '"Budapest>Azur>Techtorial>Terem I."' && jsonContent[i].userName != "") {
        w = w + 1
	var request = require("request");
        var options = {
            ...
            body: {
                roomId: 'Y2lzY29zcGFyazovL3VzL1JPT00vZGY2OGJhODAtMGNlYi0xMWU3LWE5MWItMTU2ZjViMmM4YzB',
...
console.log("\n",w," vendeg erzekleve az I. teremben, Spark meghivas OK \n");
